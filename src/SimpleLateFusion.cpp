...
void SimpleLateFusion::execute() {
	...
	if(this->tempFiles &&
		InputOutput::checkFile(baseFile + "_slf_visual_histogram_" + to_string(this->vDicSize) + ".csv") &&
	 	InputOutput::checkFile(baseFile + "_slf_visual_dictionary_" + to_string(this->vDicSize) + ".csv")) {			 
	...
	if(this->tempFiles && InputOutput::checkFile(baseFile + "_slf_visual_dictionary_" + to_string(this->vDicSize) + ".csv")) {
		cout << "Loading visual dictionary from file" << endl;
		visualDictionary = InputOutput::parseCSVDescriptor(baseFile + "_slf_visual_dictionary_" + to_string(this->vDicSize) + ".csv");
	} else {
	...
	if(this->tempFiles && InputOutput::checkFile(baseFile + "_slf_aural_dictionary_" + to_string(this->aDicSize) + ".csv")) {
		cout << "Loading aural dictionary from file" << endl;
		auralDictionary = InputOutput::parseCSVDescriptor(baseFile + "_slf_aural_dictionary_" + to_string(this->aDicSize) + ".csv");
	} else {
	...
	if(aDicControl) {
		...
		if(this->tempFiles) {
			...
			InputOutput::writeCSV(baseFile + "_slf_aural_dictionary_" + to_string(this->aDicSize) + ".csv", auralDictionary);
		}		
	}
	...
	if(vDicControl) {	
		...
		if(this->tempFiles) {
			...
			InputOutput::writeCSV(baseFile + "_slf_visual_dictionary_" + to_string(this->vDicSize) + ".csv", visualDictionary);
		}	
	}
